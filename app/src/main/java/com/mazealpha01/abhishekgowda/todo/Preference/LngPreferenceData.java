...
public class LngPreferenceData extends BasePreferenceData<LngPreferenceData.ViewHolder> {
    ...
    public LngPreferenceData(Usersettings usersettings, Context context) {
    ...
    public class ViewHolder extends BasePreferenceData.ViewHolder {
        ...
        public ViewHolder(View v) {
            super(v);
            switchButton = v.findViewById(R.id.switch_lng);
            infov = (ImageView) v.findViewById(R.id.infolng);
    ...
    public BasePreferenceData.ViewHolder getViewHolder(LayoutInflater inflater, ViewGroup parent) {
        return new ViewHolder(LayoutInflater.from(context).inflate(R.layout.itemboolngpress,parent,false));
    }
    ...
    public void bindViewHolder(final ViewHolder holder) {
        ...
        if (usersettingsdata.get(0).getLongpress().equals(0)) {
        ...
        holder.switchButton.setOnCheckedChangeListener(new SwitchButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(SwitchButton view, boolean isChecked) {
                //TODO do your job
                if (isChecked)
                    dbhelper.updatelngprs(1);
                else
                    dbhelper.updatelngprs(0);
