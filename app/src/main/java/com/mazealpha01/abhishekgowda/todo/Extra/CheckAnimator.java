...
public class CheckAnimator {
    ...
    private static final String TAG = "CheckAnimator";
    ...
    public CheckAnimator(ImageView uncheck, ImageView check, TextView task, Context mContext, Dbhelper dbhelper, Integer id,Integer notificationID,String taskstring) {
